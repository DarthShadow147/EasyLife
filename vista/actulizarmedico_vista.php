      ...
      <div class="container">
	  			<article>
					...
					<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="post">
						...
						<input type="numeric" name="identificacion" placeholder="Identificación" value="<?php echo $medico['Documento'];?>" requerid>
						<input type="text" name="nombres" placeholder="Nombres:" value="<?php echo $medico['Nombre'];?>">
						<input type="text" name="apellidos" 
                            placeholder="Apellidos:"   value="<?php echo $medico['Apellido'];?>">
						<input type="email" name="correo" placeholder="Correo:" value="<?php echo $medico['Email'];?>">
						<input type="numeric" name="telefono" placeholder="Telefono:" value="<?php echo $medico['Telefono'];?>">
