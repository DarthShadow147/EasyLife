...
SELECT IdUsuario,Nombres,Apellidos,Usuario,r.Descripcion as Roll
FROM Usuarios s
	  			...
	  			<article>
					...
					<a class="agregar" href="registrarusuarios.php">Agregar Usuarios</a>
						...
						<tr>
                            ...
                            <?php echo "<td class='centrar'>"."<a href='actualizarusuario.php?id=".$Sql['IdUsuario']."' class='editar'>Editar</a>". "</td>"; ?>
						  <?php echo "<td class='centrar'>"."<a href='eliminar_usuario.php?id=".$Sql['IdUsuario']."' class='eliminar'>Eliminar</a>". "</td>"; ?>
						</tr>
						<?php endforeach; ?>
					</table>
